...
class ImageEncoder():
    ...
    def extract_feature(self,base_path):
        ...
        file = open('./data/OpenBG-IMG/openbg_best_img.pickle', 'rb')
...
if __name__ == "__main__":
    ...
    base_path = '../data/OpenBG-IMG/images/'
    model1.get_embedding(base_path)
    model1.save_embedding('./data/OpenBG-IMG/openbg_vit_best_img_vec.pickle')

    # model2 = Resnet50()
    # base_path = '/data/lilei/multimodal-project/KG-BERT/dataset/FB15k-images/'
    ...
    # model3.save_embedding('fb15k_vgg16_best_img_vec.pickle')

    # model4 = PHash()
    # base_path = '/data/lilei/multimodal-project/KG-BERT/dataset/FB15k-images/'
    # model4.get_embedding(base_path,2)
    # model4.save_embedding('fb15k_phash_best_img_vec.pickle')
